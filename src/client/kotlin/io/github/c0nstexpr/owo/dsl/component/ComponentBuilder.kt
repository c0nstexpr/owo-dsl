...
fun ComponentBuilder.applyTo(component: Component) {
    ...
    positioningAnimation.applyBuild {
        component.positioning().animate(
            it.duration,
            it.easing,
            it.to
        )
    ...
    marginsAnimation.applyBuild(component::marginsAnimation)
    horizontalSizingAnimation.applyBuild(component::horizontalSizingAnimation)
    verticalSizingAnimation.applyBuild(component::verticalSizingAnimation)
